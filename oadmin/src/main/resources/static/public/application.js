...
var buf = [];
var locals_ = (locals || {}),version = locals_.version;buf.push("<h2>Welcome to Spine.js version " + (jade.escape((jade.interp = version) == null ? '' : jade.interp)) + "</h2><p>Time to get busy with this magic!</p>");;return buf.join("");
};}
});
